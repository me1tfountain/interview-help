...
export function createRtasrWebSocket({
  ...
  function connect() {
    try {
      ws = new WebSocket(getRtasrWebSocketUrl())
    } catch (err) {
    ...
    ws.onclose = () => {
      ...
      if (reconnectAttempts < MAX_RECONNECT_ATTEMPTS) {
        ...
        reconnectAttempts++
        onReconnect?.(reconnectAttempts, MAX_RECONNECT_ATTEMPTS)
  ...
  // Return a wrapped WebSocket-like object
  return {
